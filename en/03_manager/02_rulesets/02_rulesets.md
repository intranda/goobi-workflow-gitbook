...
{% embed url="https://docs.goobi.io/ugh-en/" %}
https://docs.goobi.io/ugh-en/
{% endembed %}
...
![List of configurable rulesets in Goobi](30-56e.png)

If you click on the `Create new ruleset` link, Goobi will display a dialog box allowing you to create an additional ruleset.

| Icon                                                   | Description           |
| ------------------------------------------------------ | --------------------- |
| ![ruleset\_02.png](ruleset\_02.png) | Create new ruleset    |
| ![ruleset\_01.png](ruleset\_01.png) | Edit existing ruleset |
...
![Dialogue box for specifying a ruleset](30-57e.png)

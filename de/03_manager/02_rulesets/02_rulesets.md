...
![Liste der konfigurierten Regelsätze in Goobi](30-56d.png)

Ein Klick auf den Link `Neuen Regelsatz anlegen` öffnet eine Bearbeitungsmaske zum Anlegen eines weiteren Regelsatzes.

| Icon                                                   | Beschreibung                     |
| ------------------------------------------------------ | -------------------------------- |
| ![ruleset\_02.png](ruleset\_02.png) | Neuen Regelsatz anlegen          |
| ![ruleset\_01.png](ruleset\_01.png) | Bestehenden Regelsatz bearbeiten |
...
![Bearbeitungsmaske für die Erfassung eines Regelsatzes](30-57d.png)

...
1. Die Konfigurationsdatei [goobi_mail.xml](../../../04_admin/06_config_files/05_goobi_mail.xml/05_goobi_mail.xml.md) anlegen und anpassen
2. Ein `jwtSecret` in der Datei [goobi_config.properties](../../../04_admin/06_config_files/02_goobi_config.properties/02_goobi_config.properties.md) setzen
3. Den Mail-Deaktivierungs-Endpoint in der  Datei [goobi_rest.xml](../../../04_admin/06_config_files/12_goobi_rest.xml/12_goobi_rest.xml.md) freischalten
{% endhint %}

...
![Hinzufügen eines neuen Strukturelements inklusive Seitenzuweisung und Haupttitel](screen_de.png)
...
| Icon | Bedeutung |
| :--- | :--- |
| ![icon_mets_leftright.png](icon_mets_leftright.png) | Bedienelemente zur Zuweisung der Start- oder Endseite eines neuen Strukturelements |
| ![icon_mets_image.png](icon_mets_image.png) | Das aktuell angezeigte Bild als Start- oder Endseite verwenden |
| ![icon_mets_left.png](icon_mets_left.png) | Das vorherige Bild als Start- oder Endseite verwenden |
| ![icon_mets_right.png](icon_mets_right.png) | Das nachfolgende Bild als Start- oder Endseite verwenden |
